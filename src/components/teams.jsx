...
const ClubsDetails = () => {
                ...
                <div className="bg-slate-900 grid grid-rows-1 text-slate-300">
                    <div className="grid justify-center m-5">
                        ...
                        <div className="grid justify-center">
                            <h2 className="grid justify-center w-30 font-bold uppercase mt-3 p-3 drop-shadow-lg text-slate-300">Clubs</h2>
    ...
    return (
        <div className="bg-slate-900 grid justify-center">
            <h2 className="grid justify-center w-30 font-bold mt-3 uppercase p-3 drop-shadow-lg text-slate-300">Clubs</h2>
            <div className="w-80 grid content-center">
                <div
