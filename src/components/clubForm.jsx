        ...
        <div className="bg-slate-900 grid-rows-2 grid justify-center">
            <div className="pt-10 pb-20 gap-2 ">
                ...
                <form
                    ...
                    <caption className="grid col-span-2 font-bold text-lg">NEW CLUB</caption>
                    ...
                    <button
                        className="bg-sky-500 hover:bg-sky-700 px-5  my-3 py-2 text-sm leading-5 rounded-full font-semibold col-span-2 text-white justify-self-center"
                        type="submit">New Club
                    </button>
                </form>
            </div>
        </div>
